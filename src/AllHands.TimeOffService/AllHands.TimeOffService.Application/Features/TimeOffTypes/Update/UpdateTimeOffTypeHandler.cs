...
public sealed class UpdateTimeOffTypeHandler(IDocumentStore documentStore, IUserContext userContext, TimeProvider timeProvider) : IRequestHandler<UpdateTimeOffTypeCommand>
{
