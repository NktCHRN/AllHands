...
WORKDIR /src
COPY ["AllHands.TimeOffBalanceAutoUpdater.csproj", "AllHands.TimeOffBalanceAutoUpdater/"]
RUN dotnet restore "AllHands.TimeOffBalanceAutoUpdater/AllHands.TimeOffBalanceAutoUpdater.csproj"

WORKDIR "/src/AllHands.TimeOffBalanceAutoUpdater"
COPY . .
RUN dotnet build "AllHands.TimeOffBalanceAutoUpdater.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AllHands.TimeOffBalanceAutoUpdater.csproj" \
...
Execute unit tests
```
cd "AllHands.TimeOffBalanceAutoUpdater/test/AllHands.TimeOffBalanceAutoUpdater.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "AllHands.TimeOffBalanceAutoUpdater/src/AllHands.TimeOffBalanceAutoUpdater"
